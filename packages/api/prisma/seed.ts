  ...
  await Promise.all([
    prisma.agent.create({
      data: {
        ...
        config: { specialty: "operations", triggers: ["task.blocked", "workload.imbalanced"] },
    ...
    prisma.agent.create({
      data: {
        ...
        config: { specialty: "finance", triggers: ["task.finance_created"] },
    ...
    prisma.agent.create({
      data: {
        ...
        config: { specialty: "customer", triggers: ["task.comment_escalation"] },
    ...
    prisma.agent.create({
      data: {
        ...
        name: "Flux",
        type: AgentType.DEV,
        config: { specialty: "dev", triggers: ["task.bug_created"] },
        memoryNs: "acme/dev",
        isActive: true,
        approvalMode: "always",
        createdBy: superAdmin.id,
