  ...
  theme: {
    extend: {
      colors: {
        ...
        'surface-container':        'var(--surface-container, #1e201f)',
        'surface-container-low':    'var(--surface-container-low, #1a1c1b)',
        'surface-container-lowest': 'var(--surface-container-lowest, #0d0f0e)',
