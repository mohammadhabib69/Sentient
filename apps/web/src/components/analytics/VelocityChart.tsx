    ...
    <div className="flex h-full flex-col rounded-xl border border-[var(--glass-border)] bg-[var(--surface-1)] shadow-sm">
      <div className="flex items-center justify-between border-b border-[var(--glass-border)] p-5">
        <div>
          ...
          <p className="mt-1 text-xs text-[var(--foreground-3)]">Tasks completed over the last 30 days</p>
        </div>
      </div>
      <div className="flex-1 p-5">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={MOCK_VELOCITY_DATA} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <Line 
              ...
              strokeWidth={3}
              dot={false}
              activeDot={{ r: 6, fill: "hsl(var(--primary))", stroke: "var(--surface-1)", strokeWidth: 2 }}
            />
            <Line 
              type="monotone" 
              ...
              strokeWidth={3}
              dot={false}
              activeDot={{ r: 6, fill: "hsl(var(--secondary))", stroke: "var(--surface-1)", strokeWidth: 2 }}
            />
          </LineChart>
        </ResponsiveContainer>
      </div>
