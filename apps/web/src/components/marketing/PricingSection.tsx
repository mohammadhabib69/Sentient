const PLANS = [
  { name: "Starter", price: "$0", description: "For teams exploring autonomous workflows." },
  {
    name: "Pro",
    price: "$99",
    description: "Production-ready automation for growing companies.",
    featured: true,
  },
  {
    name: "Business",
    price: "$299",
    description: "Advanced governance and multi-workspace control.",
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "Dedicated infrastructure, SSO, and priority support.",
  },
];
          ...
          {PLANS.map((plan) => (
            <div
              ...
              className={[
                ...
                plan.featured
                  ? "border-primary shadow-[0_0_20px_rgba(116,149,155,0.2)] lg:-translate-y-2"
                  : "",
              ].join(" ")}
            >
