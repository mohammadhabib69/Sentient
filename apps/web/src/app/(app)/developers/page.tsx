    ...
    <div className="space-y-6">
      <div className="glass-panel rounded-xl p-8 mb-6 text-center bg-gradient-to-r from-primary/10 to-secondary/10">
        ...
        <p className="text-sm text-[var(--foreground-2)]">
          Manage your API keys, webhooks, and explore the plugin marketplace.
        </p>
      </div>
        ...
        <div className="border border-[var(--glass-border)] rounded-lg overflow-hidden">
          ...
          >
            <span className="flex items-center gap-1">
              <ChevronRight
                className={cn("size-3.5 transition-transform", responseExpanded ? "rotate-90" : "")}
              />
              Response Preview
            </span>
      ...
      <div className="glass-panel rounded-xl p-5 space-y-4">
        <h3 className="text-sm font-bold text-foreground">Recent API Activity</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className={cn("font-bold", isPost ? "text-primary" : "text-secondary")}>
                        {row.method}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-3 text-right text-[var(--foreground-2)]">
                      {row.latency}
                    </td>
                  </motion.tr>
                );
