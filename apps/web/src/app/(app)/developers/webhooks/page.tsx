    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-xs text-[var(--foreground-2)]">Subscribe to real-time events from your AI fleet</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {webhooks.map((wh) => (
          <div key={wh.id} className="glass-panel rounded-xl p-5 flex flex-col justify-between gap-4 border border-[var(--glass-border)]">
                        ...
                        return (
                          ...
                          >
                            <div className={cn(
                              ...
                              isChecked ? "border-primary bg-primary text-white" : "border-[var(--glass-border)]"
                            )}>
