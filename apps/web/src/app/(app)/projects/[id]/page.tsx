...
const PROJECT_MOCKS: Record<string, ProjectData> = {
  proj_1: {
    ...
    members: [
      { name: "Mohammad Habib", role: "Super Admin", avatarUrl: "/avatars/user.png", initials: "MH" },
    ...
    recentActivity: [
      { id: "act_1", user: "Flux", action: "assigned task to Sarah Jenkins", time: "2 hours ago", iconType: "assign" },
      { id: "act_2", user: "Sarah Jenkins", action: "completed task review for database migrations", time: "4 hours ago", iconType: "complete" },
      { id: "act_3", user: "Alex Patel", action: "marked task 'Fix Webhook delivery' as blocked", time: "1 day ago", iconType: "block" },
      { id: "act_4", user: "Flux", action: "created task 'Optimize Prisma queries'", time: "1 day ago", iconType: "create" },
      { id: "act_5", user: "Mohammad Habib", action: "commented on 'Design API schema'", time: "2 days ago", iconType: "comment" }
    ]
  },
  proj_2: {
    id: "proj_2",
    ...
    recentActivity: [
      { id: "act_1", user: "Nova", action: "flagged Stripe webhook route as blocked", time: "30 mins ago", iconType: "block" },
      { id: "act_2", user: "Sarah Jenkins", action: "completed 'Stripe SDK update'", time: "3 hours ago", iconType: "complete" },
      { id: "act_3", user: "Alex Patel", action: "assigned 'Audit payload structures' to Nova", time: "1 day ago", iconType: "assign" },
      { id: "act_4", user: "Nova", action: "created task 'SSL cert renewal'", time: "2 days ago", iconType: "create" },
      { id: "act_5", user: "Sarah Jenkins", action: "commented on 'Stripe API Migration'", time: "3 days ago", iconType: "comment" }
    ]
  },
  proj_3: {
    id: "proj_3",
    ...
    recentActivity: [
      { id: "act_1", user: "Echo", action: "generated ad copy variations", time: "1 hour ago", iconType: "create" },
      { id: "act_2", user: "Emily Ross", action: "completed campaign outline", time: "5 hours ago", iconType: "complete" },
      { id: "act_3", user: "Chen Wei", action: "assigned 'Setup Pixel tracking' to Echo", time: "1 day ago", iconType: "assign" },
      { id: "act_4", user: "Echo", action: "completed tracking pixel validation", time: "1 day ago", iconType: "complete" },
      { id: "act_5", user: "Emily Ross", action: "commented on ad creatives feedback", time: "2 days ago", iconType: "comment" }
    ]
  },
  proj_4: {
    id: "proj_4",
    ...
    recentActivity: [
      { id: "act_1", user: "Emily Ross", action: "created task 'Finalize logo palette'", time: "4 hours ago", iconType: "create" },
      { id: "act_2", user: "Chen Wei", action: "completed 'Define brand voice'", time: "6 hours ago", iconType: "complete" },
      { id: "act_3", user: "Emily Ross", action: "assigned 'Create SVG assets' to Chen Wei", time: "1 day ago", iconType: "assign" },
      { id: "act_4", user: "Chen Wei", action: "commented on style guide draft", time: "2 days ago", iconType: "comment" },
      { id: "act_5", user: "Emily Ross", action: "started project setup", time: "3 days ago", iconType: "create" }
    ]
  }
}
      ...
      <div className="flex-1 p-6 space-y-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="glass-panel rounded-xl p-5 border border-[var(--glass-border)] flex items-center justify-between shadow-[var(--shadow-card)] transition-all hover:scale-[1.01]">
            <div className="space-y-1">
              <span className="text-xs font-mono text-[var(--foreground-3)] uppercase tracking-wider">Total Tasks</span>
              <h3 className="text-3xl font-bold tracking-tight text-foreground">{project.totalTasks}</h3>
          ...
          <div className="glass-panel rounded-xl p-5 border border-[var(--glass-border)] flex items-center justify-between shadow-[var(--shadow-card)] transition-all hover:scale-[1.01]">
            <div className="space-y-1">
              <span className="text-xs font-mono text-[var(--foreground-3)] uppercase tracking-wider">Completed</span>
              <div className="flex items-baseline gap-1.5">
                <h3 className="text-3xl font-bold tracking-tight text-foreground">{project.completedTasks}</h3>
                <span className="text-xs font-semibold text-forest-green dark:text-emerald-400">({project.completedPercentage})</span>
              </div>
          ...
          <div className="glass-panel rounded-xl p-5 border border-[var(--glass-border)] flex items-center justify-between shadow-[var(--shadow-card)] transition-all hover:scale-[1.01]">
            <div className="space-y-1">
              <span className="text-xs font-mono text-[var(--foreground-3)] uppercase tracking-wider">Blocked</span>
              <h3 className={cn(
                "text-3xl font-bold tracking-tight",
                project.blockedTasks > 0 ? "text-red-500" : "text-foreground"
              )}>{project.blockedTasks}</h3>
            ...
            <div className={cn(
              ...
              project.blockedTasks > 0 ? "bg-red-500/10 text-red-500" : "bg-[var(--surface-2)] text-[var(--foreground-3)]"
            )}>
          ...
          <div className="glass-panel rounded-xl p-5 border border-[var(--glass-border)] flex items-center justify-between shadow-[var(--shadow-card)] transition-all hover:scale-[1.01]">
            <div className="space-y-1">
              <span className="text-xs font-mono text-[var(--foreground-3)] uppercase tracking-wider">Due in</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
                  ...
                  {project.recentActivity.map((act) => {
                    ...
                    return (
                      <div key={act.id} className="flex gap-4 items-start relative z-10">
                        <div className={cn("size-6 rounded-full flex items-center justify-center border border-[var(--glass-border)] shadow-sm shrink-0", iconBg)}>
                        ...
                        <div className="space-y-0.5 min-w-0">
                          ...
                          <span className="text-[10px] text-[var(--foreground-3)] font-mono block">{act.time}</span>
                        </div>
                      </div>
                    )
                  })}
            ...
            <div className="glass-panel rounded-xl border border-[var(--glass-border)] p-6 space-y-4 shadow-[var(--shadow-card)]">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-sm font-semibold text-foreground">Task Status Distribution</h4>
                </div>
                <span className="text-xs font-mono text-[var(--foreground-3)]">Total: {project.totalTasks} tasks</span>
              </div>
              ...
              <div className="h-3.5 w-full rounded-full overflow-hidden flex bg-[var(--surface-3)] border border-[var(--glass-border)] shadow-inner">
                {project.statusDistribution.done > 0 && (
                  <div
                    style={{ width: `${(project.statusDistribution.done / project.totalTasks) * 100}%` }}
                ...
                {project.statusDistribution.inProgress > 0 && (
                  <div
                    style={{ width: `${(project.statusDistribution.inProgress / project.totalTasks) * 100}%` }}
                ...
                {project.statusDistribution.review > 0 && (
                  <div
                    style={{ width: `${(project.statusDistribution.review / project.totalTasks) * 100}%` }}
                ...
                {project.statusDistribution.todo > 0 && (
                  <div
                    style={{ width: `${(project.statusDistribution.todo / project.totalTasks) * 100}%` }}
                ...
                {project.statusDistribution.blocked > 0 && (
                  <div
                    style={{ width: `${(project.statusDistribution.blocked / project.totalTasks) * 100}%` }}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 pt-2">
                <div className="space-y-1">
                  ...
                  <p className="text-xs font-semibold pl-3.5 text-foreground">{project.statusDistribution.todo} <span className="text-[10px] text-[var(--foreground-3)]">({Math.round((project.statusDistribution.todo / project.totalTasks) * 100)}%)</span></p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs text-[var(--foreground-2)]">
                  ...
                  <p className="text-xs font-semibold pl-3.5 text-foreground">{project.statusDistribution.inProgress} <span className="text-[10px] text-[var(--foreground-3)]">({Math.round((project.statusDistribution.inProgress / project.totalTasks) * 100)}%)</span></p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs text-[var(--foreground-2)]">
                  ...
                  <p className="text-xs font-semibold pl-3.5 text-foreground">{project.statusDistribution.review} <span className="text-[10px] text-[var(--foreground-3)]">({Math.round((project.statusDistribution.review / project.totalTasks) * 100)}%)</span></p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs text-[var(--foreground-2)]">
                  ...
                  <p className="text-xs font-semibold pl-3.5 text-foreground">{project.statusDistribution.done} <span className="text-[10px] text-[var(--foreground-3)]">({Math.round((project.statusDistribution.done / project.totalTasks) * 100)}%)</span></p>
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs text-[var(--foreground-2)]">
                  ...
                  <p className="text-xs font-semibold pl-3.5 text-foreground">{project.statusDistribution.blocked} <span className="text-[10px] text-[var(--foreground-3)]">({Math.round((project.statusDistribution.blocked / project.totalTasks) * 100)}%)</span></p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="glass-panel rounded-xl border border-[var(--glass-border)] p-6 shadow-[var(--shadow-card)] flex flex-col items-center justify-center text-center">
              <span className="text-xs font-mono text-[var(--foreground-3)] uppercase tracking-wider mb-4">Project Health</span>
              ...
              <div className="relative size-32 flex items-center justify-center my-1">
                ...
                <svg className="size-full transform -rotate-90">
                  ...
                  {project.health.percentage !== null ? (
                    <circle
                      ...
                      cy="64"
                      r="54"
                      className={cn("fill-none transition-all duration-1000", project.health.strokeColor)}
                      strokeWidth="8"
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  {project.health.percentage !== null && (
                    <span className="text-[10px] uppercase font-bold text-forest-green dark:text-emerald-400 tracking-wider">Healthy</span>
                  )}
                </div>
              </div>
            ...
            <div className="glass-panel rounded-xl border border-[var(--glass-border)] p-6 space-y-4 shadow-[var(--shadow-card)]">
              ...
              <div className="divide-y divide-[var(--glass-border)]">
                {project.members.map((member, i) => (
                  <div key={i} className={cn("flex items-center justify-between py-3", i === 0 ? "pt-0" : "", i === project.members.length - 1 ? "pb-0" : "")}>
                    <div className="flex items-center gap-3">
                      <Avatar size="sm">
                        {member.avatarUrl && <AvatarImage src={member.avatarUrl} alt={member.name} />}
                        <AvatarFallback className="bg-primary/10 text-primary font-semibold text-xs">{member.initials}</AvatarFallback>
                      </Avatar>
                      <div>
            ...
            <div className="glass-panel rounded-xl border border-[var(--glass-border)] p-6 space-y-4 shadow-[var(--shadow-card)] bg-primary/[0.02]">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono text-[var(--foreground-3)] uppercase tracking-wider">Lead Agent</span>
                {project.leadAgent && (
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h5 className="text-xs font-bold text-foreground">{project.leadAgent.name}</h5>
                        <p className="text-[10px] text-[var(--foreground-3)]">{project.leadAgent.role}</p>
                      </div>
                    </div>
                    
                    {/* Pulsing Status Dot */}
                    <div className="flex items-center gap-1.5">
                      <span className={cn("size-2 rounded-full status-pulse", project.leadAgent.colorClass)} />
                      <span className="text-[10px] font-mono text-[var(--foreground-2)]">{project.leadAgent.status}</span>
                    </div>
                  </div>
                  
                  <p className="text-xs text-[var(--foreground-2)] leading-relaxed">
                    Continuously checks board task status, resolves dependency blocks, and reports health diagnostics to the workspace.
                  </p>
                </div>
              ) : (
                <div className="text-center py-4 space-y-2">
                  <Bot className="size-8 mx-auto text-[var(--foreground-3)]" />
                  <p className="text-xs text-[var(--foreground-2)] font-medium">No Lead Agent Assigned</p>
                  <p className="text-[10px] text-[var(--foreground-3)]">Assign an agent in project settings to enable automation.</p>
                </div>
              )}
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 glass-panel rounded-xl border border-[var(--glass-border)] shadow-[var(--shadow-card)] bg-[var(--surface-1)]">
          <div className="space-y-0.5 text-center sm:text-left">
            ...
            <p className="text-[10px] text-[var(--foreground-3)]">Access taskboards, interactive graphs, or report summaries.</p>
          </div>
