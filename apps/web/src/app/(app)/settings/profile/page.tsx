  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-[var(--foreground-3)]">Manage your personal information and preferences.</p>
      </div>
      ...
      <div className="rounded-2xl border border-[var(--glass-border)] bg-[var(--surface-1)] p-6 shadow-sm">
        <div className="mb-6">
          ...
          <p className="text-sm text-[var(--foreground-3)] mt-1">Select your preferred interface theme.</p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          >
            <div className="flex w-full items-center justify-between">
              ...
              <div className={cn(
                ...
                theme === "light" ? "border-[hsl(var(--primary))] bg-[hsl(var(--primary))]" : "border-[var(--glass-border)]"
              )}>
          ...
          >
            <div className="flex w-full items-center justify-between">
              ...
              <div className={cn(
                "size-4 rounded-full border flex items-center justify-center",
                theme === "dark" ? "border-[hsl(var(--primary))] bg-[hsl(var(--primary))]" : "border-[var(--glass-border)]"
              )}>
